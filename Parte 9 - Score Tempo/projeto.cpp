    ...
    if(comando=='x' || comando=='X'){
        ...
        while(!again){
            ...
            cout<<"        |                 |                 |"<<endl;
                for(int i=0; i<nivel; i++){
                    for(int j=0; j<3; j++){
                        ...
                        if(jogo[i][j]==1){cout<<"      *(1)*      "<<" ";}
                        if(jogo[i][j]==2){cout<<"     **(2)**     "<<" ";}
                        if(jogo[i][j]==3){cout<<"    ***(3)***    "<<" ";}
                        if(jogo[i][j]==4){cout<<"   ****(4)****   "<<" ";}
                        if(jogo[i][j]==5){cout<<"  *****(5)*****  "<<" ";}
                        if(jogo[i][j]==6){cout<<" ******(6)****** "<<" ";}
                        if(jogo[i][j]==7){cout<<"*******(7)*******"<<" ";}
                        }
                    }
                    cout<<endl;
                }
            ...
            if(jogo[0][1]==1 || jogo[0][2]==1){
                ...
                cout<<"Tempo: "<<tempo/100<<" segundos."<<endl;
